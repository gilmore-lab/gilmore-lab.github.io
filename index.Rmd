...
<!-- During the Fall 2020 semester, we are focusing on improving our collective data science chops thanks to the support of online training offered by -->
<!-- <img src="https://pbs.twimg.com/profile_images/883047035758313472/UM0JK6WN_400x400.jpg" height=75px width=50px> -->
<!-- [**DataCamp**](https://www.datacamp.com). Thanks, DataCamp! -->
...
The lab employs an active and engaged group of undergraduate and graduate research assistants. If you are a Penn State undergraduate student and wish to be considered for a position in the lab, complete an online application [here](https://docs.google.com/forms/d/1HgafpfTVPyMk_Wzf4b_ubzig_fs4lFGS6qh_y0sa0uE/viewform).  If you are a prospective graduate student, contact Dr. Gilmore by email.  For more information about current students and alumni, see the [student page](who-we-are.html). **We are FULL for Spring 2021**
