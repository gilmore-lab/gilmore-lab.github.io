...
- Attending: Rick, Andrea, Madison, Kayla, Cecelia, Yiming, Belle, Ysa, Bowen, Molly
  - Missing: Kavya
- Discuss:
  - [Databrary](https://nyu.databrary.org/)! What is it and why do we use it? 
  - Databrary User Guide Development using R and Bookdown for R
...
- Homework to be completed as soon as possible!
  ...
  - Everyone: Create or update (if necessary) your biography on the [lab webpage](https://gilmore-lab.github.io/who-we-are.html) and email it to Andrea for upload
